...
from msiwarp.util.read_sbd import read_sbd_meta
...
for i, mz_i in enumerate(mz_ref):
    d = mass_tolerance * mz_i / 1e6 # -+ mass_tolerance ppm around reference mass 
    mz0 = mz_i - d
    mz1 = mz_i + d    
    
    plot_range(fpath_triplets_raw, mz0, mz1, ax, 'tab:cyan', 50)
    plot_range(fpath_triplets_warped, mz0, mz1, ax, 'tab:orange', 50)
